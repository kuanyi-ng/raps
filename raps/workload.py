...
class Workload(object):
    ...
    def test(self, **kwargs):
        """ Generate standard test workload"""
        ...
        jobs.insert(0, [9472, "Max Test", cpu_trace, gpu_trace,
